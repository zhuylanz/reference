...
class ControllerTicketSystemGenerateTickets extends Controller {
    ...
    private $error;
    private $isLogin;
    protected $allowedFields = array('filter_name', 'filter_date_updated');
    ...
    public function index() {
        ...
        $this->TsLoader->TsHelper->setDefaultValues(array(
        ...
        $data['breadcrumbs'] = $this->TsLoader->TsHelper->getCatalogBreadcrumbs(array(
        ...
        $this->TsLoader->TsService->model(array(
            'model' => 'ticketsystem/supportcenter',
            'location' => 'admin'
        ));
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            $this->TsLoader->TsService->model(array(
                'model' => 'ticketsystem/tickets'
            ));
            $this->TsLoader->TsService->model(array(
                'model' => 'ticketsystem/customers'
            ));
            ...
            if ($this->customer->getId()) {
                ...
                $customers = $this->model_ticketsystem_customers->getCustomers(false, array(
                    'c.email' => $this->request->post['email']
                ));
                if ($customers)
