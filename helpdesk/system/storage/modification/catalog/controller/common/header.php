...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$this->load->language('common/header');
				  ...
				  if ($route != 'xform/xform' && $formId && ($this->request->server['REQUEST_METHOD'] == 'POST') && isset($this->request->post['data']) && $this->model_xform_xform->validateForm($formId,$this->request->post['data'])) {
