...
<div id="content">
<?php //echo $ts_column_left; ?>
<!-- <div class="col-sm-10 manage-padding"> -->
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-center"><?php if ($sort == 's.status') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 's.date_updated') { ?>
...
$('#button-clrfilter').on('click', function() {
  location = 'index.php?route=ticketsystem/sla&token=<?php echo $token; ?>';
});

$('#button-filter').on('click', function() {
	var url = 'index.php?route=ticketsystem/sla&token=<?php echo $token; ?>';
