              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'ttd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-center"><?php if ($sort == 'tt.status') { ?>
...
$('#button-clrfilter').on('click', function() {
  location = 'index.php?route=ticketsystem/types&token=<?php echo $token; ?>';
});

$('#button-filter').on('click', function() {
	var url = 'index.php?route=ticketsystem/types&token=<?php echo $token; ?>';
