            ...
            <div class="col-sm-4">
              <div class="form-group">
                ...
                <div class="input-group date">
                  <input type="text" name="filter_date_updated" value="<?php echo $filter_date_updated; ?>" placeholder="<?php echo $column_date_updated; ?>" id="input-date_updated" data-date-format="YYYY-MM-DD" class="form-control" />
            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'gd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'g.businesshour_id') { ?>
                    <a href="<?php echo $sort_business; ?>" class="<?php echo strtolower($order); ?>"><?php echo $entry_business_hours; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_business; ?>"><?php echo $entry_business_hours; ?></a>
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'g.date_updated') { ?>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $result['businesshour']; ?></td>
                  <td class="text-left"><?php echo $result['date_updated']; ?></td>
...
$('#button-clrfilter').on('click', function() {
  location = 'index.php?route=ticketsystem/groups&token=<?php echo $token; ?>';
});

$('#button-filter').on('click', function() {
	var url = 'index.php?route=ticketsystem/groups&token=<?php echo $token; ?>';
