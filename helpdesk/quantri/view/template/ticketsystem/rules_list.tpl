              ...
              <thead>
                <tr>
                  ...
                  <td class="text-center"><?php if ($sort == 'r.status') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'r.date_updated') { ?>
...
$('#button-clrfilter').on('click', function() {
  location = 'index.php?route=ticketsystem/rules&token=<?php echo $token; ?>';
});

$('#button-filter').on('click', function() {
	var url = 'index.php?route=ticketsystem/rules&token=<?php echo $token; ?>';
