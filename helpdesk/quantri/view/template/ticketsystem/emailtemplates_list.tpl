          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-center"><?php if ($sort == 'status') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'date_updated') { ?>
              ...
              <tbody>
                ...
                <?php foreach ($emailtemplates as $result) { ?>
                <tr>
...
$('#button-clrfilter').on('click', function() {
  location = 'index.php?route=ticketsystem/emailtemplates&token=<?php echo $token; ?>';
});

$('#button-filter').on('click', function() {
	var url = 'index.php?route=ticketsystem/emailtemplates&token=<?php echo $token; ?>';
