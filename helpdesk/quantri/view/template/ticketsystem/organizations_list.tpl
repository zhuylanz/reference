            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'o.name') { ?>
                    <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_name; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_name; ?>"><?php echo $column_name; ?></a>
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'o.domain') { ?>
                    <a href="<?php echo $sort_domain; ?>" class="<?php echo strtolower($order); ?>"><?php echo $entry_domain; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_domain; ?>"><?php echo $entry_domain; ?></a>
                    <?php } ?></td>
                  <td class="text-right"><?php if ($sort == 'o.date_updated') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-right"><?php echo $entry_customers; ?></td>
                  <td class="text-right"><?php echo $column_action; ?></td>
                </tr>
              </thead>
              <tbody>
                <?php if ($organizations) { ?>
                <?php foreach ($organizations as $result) { ?>
                <tr>
                  ...
                  <td class="text-right"><?php echo $result['customers']; ?></td>
...
$('#button-clrfilter').on('click', function() {
  location = 'index.php?route=ticketsystem/organizations&token=<?php echo $token; ?>';
});

$('#button-filter').on('click', function() {
	var url = 'index.php?route=ticketsystem/organizations&token=<?php echo $token; ?>';
