      ...
      <div class="panel-body">
        <div class="table-responsive">
          <table class="table table-bordered">
            <thead>
              <tr>
                <td><?php echo $text_reporting_customer_name; ?></td>
            ...
            <?php if($results){ ?>
              <?php foreach($results as $result){ ?>
                <tr>
                  ...
                  <td><?php echo ($result['first_quert_time'] ? (int)$result['first_quert_time'] : 0).$text_reporting_seconds; ?></td>
                  <td><?php echo ($result['avg_query_time'] ? (int)$result['avg_query_time'] : 0).$text_reporting_seconds; ?></td>
                </tr>
              <?php } ?>
            <?php }else{ ?>
