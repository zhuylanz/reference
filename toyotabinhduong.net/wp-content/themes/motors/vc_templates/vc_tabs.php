...
if ( 'vc_tour' === $this->shortcode ) {
	$next_prev_nav = '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="' . __( 'Previous tab', 'motors' ) . '">' . __( 'Previous tab', 'motors' ) . '</a></span> <span class="wpb_next_slide"><a href="#next" title="' . __( 'Next tab', 'motors' ) . '">' . __( 'Next tab', 'motors' ) . '</a></span></div>';
} else {
	$next_prev_nav = '';
}
