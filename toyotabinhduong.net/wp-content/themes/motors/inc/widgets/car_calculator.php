...
public function __construct() {
	$widget_ops = array('classname' => 'stm_calculator', 'description' => __('STM Auto loan Calculator', 'motors'));
	$control_ops = array('width' => 400, 'height' => 350);
	parent::__construct('stm_dealer_car_info', __('STM Auto loan Calculator', 'motors'), $widget_ops, $control_ops);
}
