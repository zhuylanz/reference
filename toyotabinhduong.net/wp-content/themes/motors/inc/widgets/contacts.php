...
class Stm_Contacts_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'contacts', // Base ID
			esc_html__('Contacts', 'motors'), // Name
			array( 'description' => esc_html__( 'Contacts widget', 'motors' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'address' ) ); ?>"><?php esc_html_e( 'Address:', 'motors' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'fax' ) ); ?>"><?php esc_html_e( 'Sales Hours:', 'motors' ); ?></label>
