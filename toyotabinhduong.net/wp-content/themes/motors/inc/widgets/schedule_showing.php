...
class Stm_Schedule_Showing extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			esc_html__('Schedule Showing', 'motors'), // Name
			array( 'description' => esc_html__( 'Schedule showing', 'motors' ), ) // Args
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		<a href="#" class="button" data-toggle="modal" data-target="#test-drive">
			...
			<?php esc_html_e('Schedule a Showing', 'motors'); ?>
		</a>
		<?php
	...
	public function form( $instance ) {
		...
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = esc_html__( 'Contact', 'motors' );
		}
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Text:', 'motors' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'phone' ) ); ?>"><?php esc_html_e( 'Phone:', 'motors' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'phone' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'phone' ) ); ?>" type="text" value="<?php echo esc_attr( $phone ); ?>">
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'phone_label' ) ); ?>"><?php esc_html_e( 'Phone Label:', 'motors' ); ?></label>
