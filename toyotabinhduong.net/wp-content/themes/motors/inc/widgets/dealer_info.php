...
public function __construct() {
	$widget_ops = array('classname' => 'stm_dealer_car_info', 'description' => __('STM Dealer Info', 'motors'));
	$control_ops = array('width' => 400, 'height' => 350);
	parent::__construct('stm_dealer_car_info', __('STM Dealer Info', 'motors'), $widget_ops, $control_ops);
}
