...
class STM_WP_Widget_Recomended_Posts extends WP_Widget {
    ...
    public function __construct() {
        ...
        $widget_ops = array(
            ...
            'description' => __( "Your site&#8217;s most recomended Posts.", 'motors' )
        );
        parent::__construct( 'stm-recomended-posts', __( 'STM Recomended For You', 'motors' ), $widget_ops );
    ...
    public function widget( $args, $instance ) {
        ...
        $title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'STM Recomended Posts', 'motors' );
