...
function aktuel_sms_output($vars){
    ...
    <div id="clienttabs">
        <ul class="nav nav-tabs">
            <li class="' . (($tab == "settings")?"active":"") . '"><a href="addonmodules.php?module=aktuel_sms&tab=settings">'.$LANG['settings'].'</a></li>
            <li class="' . ((@$_GET['type'] == "client")?"active":"") . '"><a href="addonmodules.php?module=aktuel_sms&tab=templates&type=client">'.$LANG['clientsmstemplates'].'</a></li>
            <li class="' . ((@$_GET['type'] == "admin")?"active":"") . '"><a href="addonmodules.php?module=aktuel_sms&tab=templates&type=admin">'.$LANG['adminsmstemplates'].'</a></li>
            <li class="' . (($tab == "sendbulk")?"active":"") . '"><a href="addonmodules.php?module=aktuel_sms&tab=sendbulk">'.$LANG['sendsms'].'</a></li>
            <li class="' . (($tab == "messages")?"active":"") . '"><a href="addonmodules.php?module=aktuel_sms&amp;tab=messages">'.$LANG['messages'].'</a></li>
            <li class="' . (($tab == "update")?"active":"") . '"><a href="addonmodules.php?module=aktuel_sms&amp;tab=update">'.$LANG['update'].'</a></li>
        </ul>
    </div>
    ';
    if (!isset($tab) || $tab == "settings")
    {
                ...
                foreach($classer['fields'] as $field){
                    $classersfields .=
                        '<tr>
                            ...
                            <td class="fieldarea"><input type="text" class="form-control" name="params['.$field.']" size="40" value="' . $apiparams->$field . '"></td>
                        </tr>';
                }
            }
        }
        ...
        <input type="hidden" name="action" value="save" />
            <div style="text-align: left;background-color: whiteSmoke;margin: 0px;padding: 10px;">
                <table class="table table-striped" width="100%" border="0" cellspacing="2" cellpadding="3">
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="fieldarea">
                                <select class="form-control" name="wantsmsfield">
                                    ' . $wantsms . '
                                </select>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="fieldarea">
                                <select class="form-control" name="gsmnumberfield">
                                    ' . $gsmnumber . '
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="fieldarea"><input type="text" class="form-control" name="dateformat" size="40" value="' . $settings['dateformat'] . '"> e.g:  %d.%m.%y (27.01.2014)</td>
                        </tr>
                    </tbody>
                </table>
            </div>
    ...
    elseif ($tab == "templates")
    {
        ...
        while ($data = mysql_fetch_array($result)) {
            ...
            echo '
            <tr>
                <td class="fieldlabel text-right">'.$LANG['active'].'</td>
                <td><input type="checkbox" value="on" name="' . $data['id'] . '_active" ' . $active . '></td>
            </tr>
            ';
            echo '
            <tr>
                <td class="fieldlabel text-right">'.$LANG['parameter'].'</td>
    ...
    elseif ($tab == "messages")
    {
        ...
        echo "<select class=\"form-control\"  onchange=\"this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);\">{$list}</select></div>";
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="fieldarea">
                                ...
                                <select class="form-control" name="client" multiple id="clientdrop" style="width:512px;padding:5px">
                        ...
                        <tr>
                            ...
                            <td class="fieldarea">
                               <textarea class="form-control" cols="70" rows="20" name="message" style="width:498px;padding:5px"></textarea>
                            </td>
                        </tr>
                        <tr>
